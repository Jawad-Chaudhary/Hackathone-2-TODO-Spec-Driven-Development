...
export const Modal: React.FC<ModalProps> = ({
  ...
  return (
    ...
    >
      ...
      {/* Modal Dialog - [Task T078] Responsive: smaller on mobile, optimized for all screens */}
      <div
        ref={modalRef}
        className="relative bg-white rounded-lg shadow-xl max-w-md w-full mx-4 p-4 sm:p-6 z-10 animate-fade-in"
      >
        {/* Modal Title */}
        <h2
          id="modal-title"
