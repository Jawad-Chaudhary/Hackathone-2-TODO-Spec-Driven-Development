...
- Add task: Create a new task with title, description, priority (high/medium/low), tags, due date, and recurrence (daily/weekly/monthly/custom)
- List tasks: View all tasks, or filter by pending/completed status
- Complete task: Mark a task as completed
- Delete task: Remove a task permanently
- Update task: Modify task title, description, priority, tags, due date, and recurrence

Advanced features:
- Priority levels: high, medium, low
- Tags: Categorize tasks with custom tags (e.g., "work", "personal", "urgent")
- Due dates: Set deadlines for tasks (ISO format: YYYY-MM-DD or YYYY-MM-DDTHH:MM:SS)
- Recurrence: Create recurring tasks (daily, weekly, monthly, or custom interval)
...
Examples:
- "Add a high priority task to buy groceries with tag shopping"
- "Create a weekly recurring task to review my goals every Monday"
- "Show me all my high priority tasks"
- "Add a task to submit report by 2025-02-01 with tag work"
"""
    ...
    tools = [
        {
            ...
            "function": {
                "name": "add_task",
                "description": "Create a new task for the user with Phase 5 advanced features. Use this when the user wants to add, create, or make a new task.",
                "parameters": {
                    "type": "object",
                    "properties": {
                        "title": {
                        ...
                        "tags": {
                            "type": "array",
                            "items": {"type": "string"},
                            "description": "List of tags for categorizing the task (e.g., ['work', 'urgent'])"
                        },
                        "due_date": {
                            "type": "string",
                        ...
                        "recurrence": {
                            ...
                            "description": "Recurrence pattern: 'daily', 'weekly', 'monthly', or 'custom'"
                        },
                        "recurrence_interval": {
                            "type": "integer",
                            "description": "Number of days for custom recurrence (required when recurrence is 'custom')"
                        }
                    },
                    "required": ["title"]
                }
        ...
        },
        {
            ...
            "function": {
                "name": "update_task",
                "description": "Update a task's title, description, priority, tags, due date, and recurrence. Use this when the user wants to modify, change, edit, or update a task.",
                "parameters": {
                    "type": "object",
                    "properties": {
                        "task_id": {
                        ...
                        "priority": {
                            "type": "string",
                            "enum": ["high", "medium", "low"],
                            "description": "New priority level: 'high', 'medium', or 'low' (optional)"
                        },
                        "tags": {
                            "type": "array",
                            "items": {"type": "string"},
                        ...
                        "recurrence_interval": {
                            "type": "integer",
                            "description": "New recurrence interval for custom recurrence (optional)"
                        }
                    },
                    "required": ["task_id"]
                }
